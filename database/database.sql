...
-- Volcando datos para la tabla ospos.ospos_employees: ~1 rows (aproximadamente)
...
INSERT INTO `ospos_employees` (`username`, `password`, `person_id`, `deleted`, `hash_version`, `language`, `language_code`, `api_token`, `user_role`, `isOnline`) VALUES
	('admin', '$2y$10$vJBSMlD02EC7ENSrKfVQXuvq9tNRHMtcOA8MSK2NYS748HHWm.gcG', 1, 0, 2, NULL, NULL, NULL, 1, 0);
...
-- Volcando datos para la tabla ospos.ospos_migrations: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla ospos.ospos_people: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla ospos.ospos_sessions: ~18 rows (aproximadamente)
